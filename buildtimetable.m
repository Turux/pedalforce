...
timetable.CadenceFiltRads = movmean(timetable.CadenceRads, fs/2.8);
timetable.CadenceFiltRPM = movmean(timetable.CadenceRPM, fs/2.8);
...
timetable.TorqueFiltNm = movmean(timetable.TorqueNm,fs/2.8);
...
timetable.PowerFilt30sW = movmean(timetable.PowerW,30*fs);
